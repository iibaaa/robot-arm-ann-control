...
if __name__ == "__main__":
    ...
    arguments.add_argument("--epochs", type=int, default=500)
    ...
    arguments.add_argument("--checkpoint", type=str, default="model_sigmoid_mae_50k.pth")
    arguments.add_argument("--device", type=str, default="cuda:0")
    arguments.add_argument("--output_name", type=str, default="model_sigmoid_mae_50k")
